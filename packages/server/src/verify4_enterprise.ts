...
async function verifyPhase4() {
  ...
  try {
    ...
    await db.query("INSERT INTO companies (id, name, mission) VALUES ($1, 'Enterprise Corp', 'Scale Everything')", [companyId]);
    
    // 2. Billing & Credits
    await BillingService.addCredits(companyId, 100, 'top-up', 'Initial credit pack');
    ...
    await EmailService.sendReport('admin@enterprise.com', 'Your Weekly Biuro Report', report);
